		...
		<Fragment>
			<nav className={cn('bg-background', classes.container)}>
				<div className='flex flex-col items-center gap-1'>
					<Button size='icon' variant='ghost' onClick={() => setShowTaskList(true)}>
						<TextAlignJustifyIcon className='h-[1.5rem] w-[1.5rem] rotate-0 scale-100 transition-all text-foreground' />
					</Button>
